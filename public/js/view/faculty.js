$(document).ready(function () {
    ...
    var table = $('#example').DataTable({
        ...
        scrollY: '60vh',
        scrollCollapse: true,
        ajax: '/admin/faculty/getall',
        columns: [
            { data: 'fac_id', name: 'fac_id' },
            { data: 'name', name: 'name' },
            {
                data: null,
        ...
        buttons: [
            ...
            {
                text: '<i class="plus circle icon"></i> เพิ่มข้อมูลคณะ',
    ...
    $('#example tbody').on('click', '#delete', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "get",
                    url: "/admin/faculty/delete/" + data.fac_id,
                    cache: false,
                    success: function (data) {
                        console.log('success');
                        console.log(data);
