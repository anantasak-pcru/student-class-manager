...
<script src="{{asset('js/view/check_report.js')}}" type="text/javascript"></script>
@endsection
@section('content')
<div class="container">
        ...
        <div class="column">
            <div class="table">
                <div class="ui three column grid">
                    ...
                    <div class="column">
                        <div style="width:100%" class="ui input">
                            <input id="year" type="text" placeholder="ปีการศึกษา">
                        </div>
                    ...
                    <div class="column">
                        <div style="width:100%;">
                            <button style="width:100%" id="clear" style="float:left;margin-top:5px;margin-bottom:5px"
                                class="ui red button"><i class="times icon"></i>ล้างค่า</button>
                        </div>
                        <div style="width:100%;">
                            <button id="search" style="float:left;margin-top:5px;margin-bottom:5px;width:100%"
