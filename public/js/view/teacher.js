$(document).ready(function () {
    var table = $('#example').DataTable({
        ...
        buttons: [
            ...
            {
                id: 'tset',
                text: '<i class="fas fa-user-plus"></i> เพิ่มข้อมูลอาจารย์',
    ...
    $('body').on('click', '#chk_password', async function () {
        console.log('t_id', document.getElementById("t_id").value);
        ...
        alertify.prompt('เปลี่ยนรหัสผ่าน', 'กรอกรหัสผ่าน', null,
            async function (e, value) {
                ...
                await fetch('/admin/teacher/updatepassword', {
                    headers: {
...
async function insert(table) {
    ...
    const html =
        ...
        '<div style="width:100%;" class="ui labeled input"><div class="ui label">รหัสอาจารย์</div>' +
        '<input maxlength="12" value="" id="t_id" type="text" placeholder="รหัสอาจารย์">' +
        '</div><br><br>' +
        ...
        '<input maxlength="100" value="" id="l_name" type="text" placeholder="นามสกุล">' +
        '</div><br><br>' +
        '<div style="width:100%;" class="ui labeled input"><div class="ui label">ที่อยู่</div>' +
        '<input maxlength="100" value="" id="address" type="text" placeholder="ที่อยู่">' +
        '</div><br><br>' +
        '<div maxlength="100" style="width:100%;" class="ui labeled input"><div class="ui label">เบอร์โทร</div>' +
...
async function edit(table, data) {
    ...
    const html =
        ...
        '<div style="width:100%;" class="ui labeled disabled input"><div class="ui label">รหัสอาจารย์</div>' +
        '<input readonly value="' + data.t_id + '" id="t_id" type="text" placeholder="รหัสอาจารย์">' +
        '</div><br><br>' +
        '<div style="width:100%;" class="ui labeled input"><div class="ui label">ชื่อ</div>' +
        '<input  value="' + data.f_name + '" id="f_name" type="text" placeholder="ชื่อ">' +
        '</div><br><br>' +
        '<div style="width:100%;" class="ui labeled input"><div class="ui label">นามสกุล</div>' +
        '<input  value="' + data.l_name + '" id="l_name" type="text" placeholder="ชื่อ">' +
        '</div><br><br>' +
        '<div style="width:100%;" class="ui labeled input"><div class="ui label">ที่อยู่</div>' +
...
async function _delete(table, data) {
    Swal.fire({
        ...
        text: data.t_id + "  " + data.f_name + "  " + data.l_name,
        icon: 'warning',
        showCancelButton: true,
        ...
        fetch('/admin/teacher/delete/' + data.t_id)
            .then(response => {
